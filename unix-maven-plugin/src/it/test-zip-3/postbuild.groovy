...
success &= assertZipEntries(main, [
        ...
        regularFile(r("/usr/share/hudson/LICENSE-downstream.txt"), START_OF_TIME, 15, EMPTY),
        directory(r("/usr/share/hudson/lib"), START_OF_TIME, EMPTY),
        directory(r("/usr/share/hudson/license"), START_OF_TIME, EMPTY),
        regularFile(r("/usr/share/hudson/lib/hudson.war"), START_OF_TIME, 20623413, EMPTY),
...
success &= assertZipEntries(slave, [
        ...
        regularFile(r("/usr/share/hudson/LICENSE-downstream.txt"), START_OF_TIME, 15, EMPTY),
        directory(r("/usr/share/hudson/lib"), START_OF_TIME, EMPTY),
        regularFile(r("/usr/share/hudson/lib/slave.jar"), START_OF_TIME, 158615, EMPTY),
        directory(r("/usr/share/hudson/license"), START_OF_TIME, EMPTY),
        regularFile(r("/usr/share/hudson/license/atom-license.txt"), START_OF_TIME, 49, EMPTY),
        regularFile(r("/usr/share/hudson/license/dc-license.txt"), START_OF_TIME, 1544, EMPTY),
        directory(r("usr/share/hudson/slave"), START_OF_TIME, EMPTY),
        regularFile(r("usr/share/hudson/slave/README.txt"), START_OF_TIME, 34, EMPTY),
])
